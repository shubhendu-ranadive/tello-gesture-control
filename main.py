...
def get_args():
    ...
    parser.add("--is_keyboard", help='To use Keyboard control by default',
                type=bool)
...
def main():
    ...
    # Not able to use currently due to some problem.
    # Use "tello.get_battery" instead
    ...
    while True:
        ...
        threading.Thread(target=tello_control, args=(key,
                                                    keyboard_controller,
        ...
        cv.putText(debug_image, "Battery: {}".format(tello.get_battery()),
                    (5, 720 - 5),
